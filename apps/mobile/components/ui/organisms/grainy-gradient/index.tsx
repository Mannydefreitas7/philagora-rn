...
import { Canvas, Skia, Fill, Shader, type SkRuntimeEffect } from "@shopify/react-native-skia";
import { useSharedValue, useDerivedValue, useFrameCallback, type FrameInfo } from "react-native-reanimated";
...
>(
  ({
    width: paramsWidth,
    height: paramsHeight,
    colors = ["#353535", "#181818", "#494949", "#828282"],
    speed = 1,
    animated = true,
    intensity = 0.212,
    size = 1.9,
    ...
    const shader = useMemo<SkRuntimeEffect | null>(() => Skia.RuntimeEffect.Make(GRAINY_GRADIENT_SHADER), []);
    ...
    return (
      <Canvas style={[{ width, height, position: "absolute", top: 0, left: 0 }, style]}>
        <Fill>
...
export default memo<React.FC<IGrainyGradient> & React.FunctionComponent<IGrainyGradient>>(GrainyGradient);
