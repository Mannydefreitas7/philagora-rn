...
const Events = ({ size = 24, color = "#000000", variant }: TIconProps) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      {variant === "fill" ? (
        ...
        <G clipPath="url(#clip0_4418_3808)">
          <Path d="M7 13H12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          <Path d="M7 17H16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
          <Path
