...
import type { AnimationConfig, CharacterAnimationParams, CharacterProps, StaggeredTextProps } from "./types";
...
const Character: React.FC<CharacterProps> = memo<CharacterProps>(
  ({
    ...
    exitFrom,
    exitTo,
  }: CharacterProps): React.ReactNode & React.JSX.Element & React.ReactElement => {
...
export const StaggeredText: React.FC<StaggeredTextProps> = memo<StaggeredTextProps>(
  ({
    text,
    style,
    animationConfig,
    ...
    exitFrom,
    exitTo,
  }: StaggeredTextProps): React.ReactNode & React.JSX.Element & React.ReactElement => {
    ...
    return (
      <Animated.View
        ...
        layout={LinearTransition.duration(mergedAnimationConfig.layoutTransitionDuration).easing(
          Easing.out(Easing.ease),
        )}>
        {characters.map<React.JSX.Element | React.ReactNode>((char, index) => (
          <Character
            key={`${char}-${index}`}
            char={char}
            style={style}
