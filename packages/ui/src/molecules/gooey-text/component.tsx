...
import type { FtWeight, IGooeyText, IGooeyTextItem } from "./types";
...
function useSystemFont<T extends string, S extends number, W extends FtWeight, P extends boolean>(
...
export const GooeyText = ({
	...
	const systemFont = useSystemFont(fontFamily, fontSize, fontWeight as FtWeight, !!fontSource);
