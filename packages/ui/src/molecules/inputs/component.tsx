		...
		<TextField {...props}>
			...
			<InputGroup>
				...
				<InputGroup.Input
					...
					className="bg-neutral-100  dark:bg-neutral-800 border data-[valid=true]:border-2 border-neutral-200 dark:border-neutral-700 focus:border-accent error:border-danger rounded-full px-5 data-[valid=true]:border-green-500"
