...
import { FieldError, InputGroup, Label, PressableFeedback, TextField } from "heroui-native";
      ...
      <InputGroup>
        {PrefixIcon && (
          <InputGroup.Prefix isDecorative>
            <PrefixIcon color={theme === "dark" ? "white" : "black"} variant="Outline" size={14} />
          </InputGroup.Prefix>
        )}
        <InputGroup.Input
          {...inputProps}
          data-state={!!props.valid}
          secureTextEntry={props.secureTextEntry}
          onChangeText={props.onChangeText}
          onEndEditing={props.onEndEditing}
          className="bg-neutral-100  dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 focus:border-accent error:border-danger rounded-full px-5 data-[valid=true]:border-green-500"
