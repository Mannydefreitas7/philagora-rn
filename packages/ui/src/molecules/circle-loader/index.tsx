...
export const CircleLoadingIndicator: React.FC<ICircleLoadingIndicator> = memo<ICircleLoadingIndicator>(
  ({
    dotColor = "#007AFF",
    dotRadius = 4,
    dotSpacing = 5,
    duration = 950,
    style,
  }: React.ComponentProps<typeof CircleLoadingIndicator> | ICircleLoadingIndicator): React.JSX.Element &
    React.ReactNode &
    React.ReactElement => {
    ...
    return (
      <View style={[styles.container, style]}>
        <Svg width={(dotRadius * 2 + dotSpacing) * 3} height={24}>
          <AnimatedCircle cx={dotRadius} cy={12} r={dotRadius} fill={dotColor} animatedProps={animatedProps1} />
          <AnimatedCircle
